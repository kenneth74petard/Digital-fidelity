...
Solution web complète de gestion de programme de fidélité pour commerçants de proximité (restaurants, salons de coiffure, boucheries, boulangeries, boutiques…), avec backend Node.js et interface web Expo (React).
...
- Un scope commerce (`x-restaurant-id` ou `restaurantId`/`restaurant_id`)
